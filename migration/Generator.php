...
namespace webtoolsnz\giiant\migration;
...
class Generator extends \yii\gii\Generator
{
    ...
    public function generate(){
        ...
        foreach ($this->getTables() as $tableName) {
            ...
            $params= compact('tableName','tableSchema','tableCaption','tableAlias','migrationName','tableColumns','tableIndexes', 'tableRelations');
            $files[] = new CodeFile(
